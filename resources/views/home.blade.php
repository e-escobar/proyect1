...
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
    ...
    <p class="text-sm text-gray-400 mt-2">Proyecto de desarrollo web para programadores</p>
    <img src="{{ asset('images/calendario.png')}}" class="h-60 absolute -right-0 -bottom-0 opacity-20">
</div>
        ...
        @foreach($posts as $post)
            <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
                <p class="text-xs flex items-center gap-2">
                    <span class="uppercase text-gray-700 bg-gray-200 rouded-full px-2 py-1">Tutorial</span>
